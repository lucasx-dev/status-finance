...
export const LogicProvider = ({ children }) => {
	...
	const filterTransactions = (t, transactionFilter, sortedTransactions) => {
		...
		if (transactionFilter === "saidas") return t.type === "saida";
	...
	const filterPeriodic = (t, transactionFilterPeriodic) => {
		if (transactionFilterPeriodic === "Janeiro") return new Date(t.date).getMonth() + 1 === 1;
		if (transactionFilterPeriodic === "Fevereiro") return new Date(t.date).getMonth() + 1 === 2;
		if (transactionFilterPeriodic === "Marco") return new Date(t.date).getMonth() + 1 === 3;
		if (transactionFilterPeriodic === "Abril") return new Date(t.date).getMonth() + 1 === 4;
		if (transactionFilterPeriodic === "Maio") return new Date(t.date).getMonth() + 1 === 5;
		if (transactionFilterPeriodic === "Junho") return new Date(t.date).getMonth() + 1 === 6;
		if (transactionFilterPeriodic === "Julho") return new Date(t.date).getMonth() + 1 === 7;
		if (transactionFilterPeriodic === "Agosto") return new Date(t.date).getMonth() + 1 === 8;
		if (transactionFilterPeriodic === "Setembro") return new Date(t.date).getMonth() + 1 === 9;
		if (transactionFilterPeriodic === "Outubro") return new Date(t.date).getMonth() + 1 === 10;
		if (transactionFilterPeriodic === "Novembro") return new Date(t.date).getMonth() + 1 === 11;
		if (transactionFilterPeriodic === "Dezembro") return new Date(t.date).getMonth() + 1 === 12;
		if (transactionFilterPeriodic === "Todos") return true;
