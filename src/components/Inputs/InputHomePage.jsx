...
export const CurrencyInput = ({
  ...
  return (
    <div className="flex flex-col items-center mt-5 bg-gray-950 text-white ">
      <NumericFormat
        ...
        fixedDecimalScale
        allowNegative={false}
      className={`rounded-md p-2 w-full mt-5 bg-gray-400/20 mb-3 text-center focus:outline-none focus:ring-2
